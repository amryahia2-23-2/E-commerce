...
import { EmptyCartImage } from '@/assests'
    ...
    <div className="py-10 md:py-20 bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center space-y-4">
            <h2 className="text-3xl font-bold text-gray-800">Your cart feeling lonely</h2>
        ...
        <div>
            <Link
            href={"/"}
            className="block bg-darkColor/5 border border-darkColor/20 text-center text-darkColor py-2.5  rounded-full hover:bg-darkColor hover:text-white hoverEffect"
            >
                Discover Product
            </Link>
        </div>
